                       ...
                       placeholder:nil
                          ...
                          progress:^(NSInteger receivedSize, NSInteger expectedSize) {
                              if (expectedSize > 0 && receivedSize > 0) {
                                  CGFloat progress = (CGFloat)receivedSize / expectedSize; // 进度
...
@interface MiYYWebImageController ()
{
    NSArray *_imageLinks;
}
...
@implementation MiYYWebImageController
...
- (void)viewDidLoad {
    ...
    NSArray *links = @[
                       ...
                       @"http://h.hiphotos.baidu.com/zhidao/pic/item/eac4b74543a9822628850ccc8c82b9014b90eb91.jpg",
