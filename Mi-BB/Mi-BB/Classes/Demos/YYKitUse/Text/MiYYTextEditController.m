...
@interface MiYYTextEditController () <YYTextViewDelegate, YYTextKeyboardObserver>
...
@implementation MiYYTextEditController
...
- (void)initImageView {
    NSData *data = [NSData dataNamed:@"icon1.png"];
    UIImage *image = [[YYImage alloc] initWithData:data scale:4];
