//
//  MiYYTextAttachmentController.m
//  Mi-BB
//
...
@interface MiYYTextAttachmentController ()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) YYLabel *label;
@end

@implementation MiYYTextAttachmentController
...
- (void)viewDidLoad {
    ...
    UIFont *font = [UIFont systemFontOfSize:16];
    {
        ...
        UIImage *image = [UIImage imageNamed:@"chaoren"];
