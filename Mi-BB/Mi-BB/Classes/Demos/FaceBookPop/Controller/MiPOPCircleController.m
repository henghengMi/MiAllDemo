...
@interface MiPOPCircleController()
...
@implementation MiPOPCircleController

- (void)viewDidLoad
{
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.edgesForExtendedLayout = UIRectEdgeAll;//起始点从00开始
...
- (void)addCircleView
{
    ...
    self.circleView.center = CGPointMake(self.view.centerX, self.view.centerY - 64);
