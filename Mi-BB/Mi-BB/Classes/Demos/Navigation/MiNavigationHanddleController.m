//
//  MiNavigationHanddleController.m
//  Mi-BB
//
...
@interface MiNavigationHanddleController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation MiNavigationHanddleController
...
- (void)createScaleHeadView
{
    ...
    _topImageView.image = [UIImage imageNamed:@"ttbb"];
    [topBkView addSubview:_topImageView];
    _topImageView.userInteractionEnabled = YES;
    [_topImageView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(topImageTap:)]];
